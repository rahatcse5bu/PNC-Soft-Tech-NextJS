...
const Navbar = dynamic(() =>
  import("@material-tailwind/react").then((mod) => mod.Navbar),
  { ssr: false }
);
const IconButton = dynamic(() =>
  import("@material-tailwind/react").then((mod) => mod.IconButton),
  { ssr: false }
);
const MobileNav = dynamic(() =>
  import("@material-tailwind/react").then((mod) => mod.MobileNav),
  { ssr: false }
);
